...
public class LoginInteractorTest {
    ...
    // TD Task 2.2: make a copy of this test method and follow the instructions in the readme to test your
    //                code from Task 2.1..
    ...
    public void successUserLoggedInTest() {
        ...
        // Before the login, assert that no user is currently logged in (null)
        ...
        // Execute interactor to log the user in.
